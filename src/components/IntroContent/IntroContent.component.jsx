...
const IntroContent = () => {
  return (
    <section className="flex lg:h-4/6 justify-center items-center" id="Intro">
      <div className="flex flex-col">
        <div className="flex flex-col lg:space-x-9 ">
          ...
          <div className="flex flex-col pt-8">
            <div className="flex flex-col" id="display-content">
              <div className="text-white text-2xl lg:text-4xl text-center lg:pb-3">
                Hello, I am Shubhankar🖐
              </div>
              <div className="text-white text-lg lg:text-2xl text-center italic">
                Front-End Web Developer
              </div>
            </div>
            <div className="flex justify-evenly pt-8" id="social-links">
              <a
                className=""
